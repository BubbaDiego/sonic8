...
PYTHON_EXEC = sys.executable  # Ensure you're in your venv
...
def launch_frontend():
    ...
    run_background("npm run dev", FRONTEND_DIR)
    wait_and_open("http://localhost:5173")
    console.log("[green]Frontend running at http://localhost:5173[/]")
