...
```txt
auto_core/
├── auto_core.py        # 🤖 High le[base_monitor.py](../monitor_core/base_monitor.py)vel Phantom automation
...
- Wallet interactions are encapsulated in `phantom_workflow` f[auto_core.py](auto_core.py)unctions.
