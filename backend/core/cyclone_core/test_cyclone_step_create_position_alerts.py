...
def generate_dummy_position(asset):
    return {
        "id": str(uuid4()),
        "asset_type": asset,
        "position_type": "LONG",  # ✅ ensure uppercase for valid filtering
        "entry_price": 100,
        "current_price": 150,
...
def test_create_position_alerts():
    ...
    expected_alerts = 5 * 2  # 2 alerts per position (heat + travel or whatever is defined)
