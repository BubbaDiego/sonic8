...
from positions_core.position_store import PositionStore
from positions_core.position_enrichment_service import PositionEnrichmentService
from positions_core.position_enrichment_service import validate_enriched_position
...
class PositionCore:
    ...
    def update_positions_from_jupiter(self, source="console"):
        ...
        """
        from positions_core.position_sync_service import PositionSyncService
