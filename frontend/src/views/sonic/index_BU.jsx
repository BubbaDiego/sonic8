...
/**
 * Y-coordinate (in px) where ROW 2 begins.
 * Example: 400 → second row starts at 400 px vertically.
 */
export const ROW_2_START_Y = 400;

/**
 * Y-coordinate (in px) where ROW 3 begins.
 * Example: 800 → third row starts at 800 px vertically.
 */
export const ROW_3_START_Y = 800;
