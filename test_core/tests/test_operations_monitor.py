...
def test_run_configuration_test_default_file(tmp_path, monkeypatch):
    """OperationsMonitor should accept a freshly generated default file."""
    default_file = tmp_path / "alert_thresholds.json"

    import utils.startup_service as ss
    ...
    monkeypatch.setattr(om, "ALERT_THRESHOLDS_PATH", default_file)
