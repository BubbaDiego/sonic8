...
TEST_VALID_FILE = "test_core/tests/mock_alert_thresholds_valid.json"
TEST_INVALID_SCHEMA_FILE = "test_core/tests/mock_alert_thresholds_invalid_schema.json"
TEST_MISSING_FILE = "test_core/tests/mock_missing_file.json"
TEST_BROKEN_JSON_FILE = "test_core/tests/mock_broken_json.json"
...
def setup_mock_files():
    ...
    os.makedirs("test_core/tests", exist_ok=True)
