...
def test_link_hedges_assigns_same_id_for_long_and_short(hedge_core):
    long_position = {"id": "long1", "wallet_name": "walletA", "asset_type": "BTC", "position_type": "LONG"}
    short_position = {"id": "short1", "wallet_name": "walletA", "asset_type": "BTC", "position_type": "SHORT"}
...
def test_link_hedges_preserves_existing_ids(hedge_core):
    ...
    long_position = {"id": "long1", "wallet_name": "walletA", "asset_type": "BTC", "position_type": "LONG", "hedge_buddy_id": existing_id}
    short_position = {"id": "short1", "wallet_name": "walletA", "asset_type": "BTC", "position_type": "SHORT"}
    hedge_core.dl.positions.create_position(long_position)
    hedge_core.dl.positions.create_position(short_position)
