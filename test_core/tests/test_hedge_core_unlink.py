...
def test_unlink_hedges_clears_ids(hedge_core):
    ...
    positions = [
        {"id": "long1", "wallet_name": "walletA", "asset_type": "BTC", "position_type": "LONG", "hedge_buddy_id": hedge_id},
        {"id": "short1", "wallet_name": "walletA", "asset_type": "BTC", "position_type": "SHORT", "hedge_buddy_id": hedge_id}
    ]
